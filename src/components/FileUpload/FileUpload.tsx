...
const FileUpload: React.FC<FileUploadProps> = ({
  ...
  const validateFile = (file: File): boolean => {
    ...
    if (file.size > maxSizeBytes) {
      ...
      setError(errorMsg)
      logger.warn('File validation failed', { error: errorMsg, fileSize: file.size, maxSize: maxSizeBytes })
      return false
    }
    ...
    if (!isValidType) {
      ...
      setError(errorMsg)
      logger.warn('File validation failed', { error: errorMsg, fileType: file.type, allowedTypes })
      return false
    }
